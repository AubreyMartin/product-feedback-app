...
const MyCardComponent = () => {
  ...
  return (
    ...
    >
      <Typography>05 Tablet Roadmap Page</Typography>
      <Box
        sx={{
          minHeight: "113px",
          maxHeight: "113px",
      ...
      >
         <Typography variant="h2" sx={{ padding: "10px" ,margin: '30px 0px 0px 0px'}}>
          Go Back
        ...
        <Button sx={{ margin: '34px 0px 34px 0px', minHeight: '44px', maxHeight: '44px', minWidth: '158px', maxWidth: '158px', background: 'white', }}>
          +Add Feedback
        </Button>
      ...
      >
       <Box sx={{    display:"flex",
        ...
        <Typography variant="h2" color="secondary.light" sx={{ margin:'10px 50px 10px 10px'}} >
    
          Planned (2)
        </Typography>
        <Typography variant="h2" color="secondary.light" sx={{ margin:'10px 59px 10px 10px'}}>
    
          In-Progress (3)
        </Typography>
        <Typography variant="h2" color="secondary.light" sx={{ margin:'10px 0px 10px 10px'}}>
