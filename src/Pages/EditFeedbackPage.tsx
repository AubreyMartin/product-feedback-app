...
const MyCardComponent = () => {
  ...
  return (
    ...
    <Card
      ...
      sx={{
        backgroundColor: "white",minHeight: 893,maxHeight: 893,minWidth: 327,maxWidth: 327, borderRadius: '10px',
      }}>
    ...
    >
      ...
      <CardContent sx={{minHeight: 308,maxHeight: 308,
       ...
       {/* Heading */}
        ...
        {/* Feedback Title */}
          ...
          <TextField variant="outlined"  fullWidth  placeholder="Add a dark theme option" />   
          </Box>
      ...
      <CardActions sx={{
            ...
            <Button sx={{minHeight: 40,maxHeight: 40,
                     ...
                     backgroundColor: "primary.main",color: '#F2F4FE', padding: '10px' }}> Save Changes</Button>
