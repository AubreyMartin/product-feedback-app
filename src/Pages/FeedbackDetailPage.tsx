            ...
            <CardActions sx={{ flexDirection: "column", padding: 2 }}>
              <Button
                sx={{
                  ...
                  color: "info.main",
                  marginLeft: '24px', marginRight: '200px',
                }}
              >
                Feature
              </Button>
    ...
    >
        <svg width="40" height="19" viewBox="0 0 40 19" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g clip-path="url(#clip0_0_196)">
                <path d="M2.62074 17H1.34534L2.24718 16.0895C2.73344 15.5986 3.0371 14.9601 3.11873 14.2674C1.03637 12.8878 0 10.8892 0 8.79388C0 4.92832 3.51913 1 9.0305 1C14.8692 1 18 4.61479 18 8.45522C18 12.321 14.8361 15.9333 9.0305 15.9333C8.0135 15.9333 6.95226 15.7963 6.00478 15.5448C5.10787 16.4735 3.89262 17 2.62074 17Z" fill="#CDD2EE"/>
                <path d="M26.6434 12.388L31.9214 4.9H33.5594V10.516H34.9894V12.388H33.5594V14H31.2714V12.388H26.6434ZM29.5554 10.802H31.5184V8.085L29.5554 10.802Z" fill="#3A4374"/>
            </g>
            <defs>
          ...
          <Card
            sx={{
              ...
              margin: "24px auto 0",
              borderRadius: 2,
              backgroundColor: "blue", padding:'24px'
            }}
          >
